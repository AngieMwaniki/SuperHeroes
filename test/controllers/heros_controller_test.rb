...
class HerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference("Hero.count") do
      post heros_url, params: { hero: { name: @hero.name, super_name: @hero.super_name } }, as: :json
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { name: @hero.name, super_name: @hero.super_name } }, as: :json
    assert_response :success
  end
